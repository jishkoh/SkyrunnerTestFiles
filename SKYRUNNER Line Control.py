...
while True:
        ...
        RightError = LINE_DETECT[1] + (LINE_DETECT[2] * 2.)
        LeftError = LINE_DETECT[5] + (LINE_DETECT[6]  * 2.)
        #print("LeftError is " + str(LeftError) + ", and RightError is " + str(RightError))
        ...
        if fourtime < 2: # running average implementation
            ...
            if right > 0: # there is non zero error at the right
                DiffSPD = Kp * right
                #PIN_SPD = AvgVar + int(DiffSPD/3)
                PIN_SPD = AvgVar - int(DiffSPD)
                PIN_SPD2 = AvgVar + int(DiffSPD*2)
                r = True
            ...
            if left > 0:
                DiffSPD = Kp * left
                #PIN_SPD = AvgVar + int(DiffSPD)
                PIN_SPD = AvgVar + int(DiffSPD*2)
                PIN_SPD2 = AvgVar - int(DiffSPD)
                r = False
            ...
            pi.set_PWM_dutycycle(PIN_1, PIN_SPD)
            pi.set_PWM_dutycycle(PIN_3, PIN_SPD2)
...
##    PIN1_SPD = 0
##    PIN2_SPD = 0
##    pi.set_PWM_dutycycle(PIN_1, 0)
##    pi.set_PWM_dutycycle(PIN_2, PIN2_SPD)
##    pi.set_PWM_dutycycle(PIN_3, PIN1_SPD)
##    pi.set_PWM_dutycycle(PIN_4, PIN2_SPD)
##    print("Servicing Keyboard Interrupt...")
##    #hd.cancel()
##    raise
##except:
##    PIN1_SPD = 0
